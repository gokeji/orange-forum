DROP TABLE IF EXISTS sql_posts;
DROP TABLE IF EXISTS sql_topics;
DROP TABLE IF EXISTS sql_forums;
DROP TABLE IF EXISTS sql_categories;
...
INSERT INTO sql_categories VALUES 
(1, "Widgets", 0),
(2, "Gizmos", 1),
(3, "Doodads", 2),
(4, "Thingamajigs", 3);

CREATE TABLE sql_forums (
   ...
   FOREIGN KEY(category_id) REFERENCES sql_categories(category_id)) ENGINE=InnoDB CHARSET=UTF8;
INSERT INTO sql_forums VALUES 
...
CREATE TABLE sql_topics (
   ...
   FOREIGN KEY(forum_id) REFERENCES sql_forums(forum_id)) ENGINE=InnoDB CHARSET=UTF8;

INSERT INTO sql_topics VALUES 
...
CREATE TABLE sql_posts (
   ...
   PRIMARY KEY(post_id),
   FOREIGN KEY(topic_id) REFERENCES sql_topics(topic_id)) ENGINE=InnoDB CHARSET=UTF8;
INSERT INTO sql_posts VALUES 
